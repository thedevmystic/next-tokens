  ...
  return (
    <ThemeProvider forcedToken="light">
      ...
      <section className="section">
        ...
        <p>
          This page-level override forces the token to 'light' on this page only, ignoring the
          user's saved preference. Useful for demos, previews, or any time you want to temporarily
          ignore the user's saved token.
          <br />
